...
Como ya se ha mencionado anteriormente en la sección ``\nameref{pruebas:proceso_ambito_mediciones}'' perteneciente al capítulo \ref{chapter:desarrollo_pruebas}, para obtener estos resultados se han utilizado dos herramientas:
\begin{itemize}
	\item
