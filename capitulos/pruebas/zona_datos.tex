...
\subsubsection{Integración continua}
	...
	\begin{itemize}
		...
		\item
			En caso de que surga algún fallo durante la ejecución de las pruebas, el servidor de integración continua notifica al autor de los cambios que lo producen.  Ésta capacidad de notificación prácticamente inmediata ha ayudad a detectar y solucionar varios problemas de forma rápida antes de que se propaguen a otras partes del sistema.
	\end{itemize}