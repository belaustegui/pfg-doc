...
\subsection{Equipamiento e instalaciones}
	...
	Además también se incluirá en esta partida el gasto necesario para amortizar el equipamiento del desarrollador.  El equipamiento ha tenido un coste inicial de \EUR{1500} y se espera amortizar en 3 años (36 meses).  El coste de amortización de este equipamiento es de \EUR{41,70} mensuales, lo que produce un coste de \EUR{213,71} a lo largo del proyecto.
	
	Por último, se incluye también el precio del entorno de desarrollo integrado utilizado por el desarrollador, este tiene un coste de \EUR{179}\footnote{La información detallada sobre el precio de este componente puede consultarse en \url{http://www.jetbrains.com/pycharm/buy/}}.
	
\subsection{Otros gastos}
	En esta partida se incluyen el resto de gastos que afectan al proyecto y no forman parte de las partidas anteriores.  Se incluye aquí un fondo para posibles imprevistos que surjan a lo largo del desarrollo, este fondo está valorado en \EUR{4000}.
...
\subsection{Total}
	Tras sumar los costes de todas las partidas se obtiene un coste total del proyecto de \EUR{35792,27}.  Puesto que este es el presupuesto de costes, no se incluirán los impuestos.  Los impuestos serán incluidos en el presupuesto del cliente tras aplicar el beneficio deseado.