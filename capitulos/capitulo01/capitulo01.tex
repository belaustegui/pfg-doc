...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{datagov.PNG}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{datagovuk.PNG}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{old_landportal_home.PNG}
\caption{Página principal del antiguo Land Portal}
\end{figure}

Los principales puntos en los que este proyecoto pretende mejorar lo ofrecido por el viejo Land Portal son:
\begin{itemize}
